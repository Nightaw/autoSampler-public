...
from tools.build_visual_assets import (
    build_agent_ecosystem,
...
class VisualAssetsTest(unittest.TestCase):
    def test_svg_builders_emit_expected_titles(self) -> None:
        ...
        self.assertIn("agent-ready repository system", build_agent_ecosystem())
    ...
    def test_interview_brief_contains_summary(self) -> None:
        ...
        self.assertIn("Agent Collaboration Positioning", markdown)
